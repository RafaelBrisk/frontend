...
const notNullValues = ['lanche.id', 'ingrediente.id', 'unidadeMedida.id', 'quantidade'];
const campos = [
  { name: 'lanche_id', body: 'lanche.id' },
  { name: 'ingrediente_id', body: 'ingrediente.id' },
  { name: 'unidade_medida_id', body: 'unidadeMedida.id' },
  { name: 'quantidade', body: 'quantidade' }
];
const baseUrl = '/api/lanche-ingrediente';
const tableName = 'lanche_ingrediente';
...
function start() {
  console.log('Lanche Ingrediente up.');
